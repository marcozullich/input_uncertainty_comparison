...
def train_dropout_model(x_train_with_noise, y_train, x_test_with_noise, y_test, epochs=15, batch_size=256):
    ...
    model.fit(x_train_with_noise, y_train, verbose=1, epochs=epochs, batch_size=batch_size)
